...
class CenterHead(nn.Module):
    ...
    def get_targets(self, gt_bboxes_3d, gt_labels_3d, gt_attr_3d): # Feng Xiang added gt_attr_3d input
        """Generate targets.
        ...
        heatmaps, anno_boxes, inds, masks = multi_apply(
            self.get_targets_single, gt_bboxes_3d, gt_labels_3d, gt_attr_3d) # Feng Xiang added gt_attr_3d input
    ...
    def get_targets_single(self, gt_bboxes_3d, gt_labels_3d, gt_attr_3d): # Feng Xiang added gt_attr_3d input
        ...
        for class_name in self.class_names:
            if '.' in class_name:
                # use gt_attr_3d as the index
                task_masks.append([
                    torch.where(gt_attr_3d == class_name.index(i) + flag_attr)
                    for i in class_name
                ])
                flat_attr += len(class_names)
            else:
                task_masks.append([
        ...
        for idx, mask in enumerate(task_masks):
            ...
            for m in mask:
                ...
                # m is in attr or labels?
                # import pdb; pdb.set_trace()
                if idx >= 6:
                    task_class.append(gt_attr_3d[m] + 1 - flag_attr2)
        ...
        for idx, task_head in enumerate(self.task_heads):
            ...
            for k in range(num_objs):
                ...
                if width > 0 and length > 0:
                    ...
                    # TODO: resolve cls_id = -2 or -3 issue
    ...
    def loss(self, gt_bboxes_3d, gt_labels_3d, gt_attr_3d, preds_dicts, **kwargs): # Feng Xiang add gt_attr_3d input
        ...
        heatmaps, anno_boxes, inds, masks = self.get_targets(
            gt_bboxes_3d, gt_labels_3d, gt_attr_3d) # Feng Xiang added gt_attr_3d as input
        loss_dict = dict()

...
def filter_eval_boxes(nusc: NuScenes,
    ...
    """
    max_dist['cycle.with_rider'] = 40
    max_dist['cycle.without_rider'] = 40
    max_dist['pedestrian.moving'] = 40
    max_dist['pedestrian.standing'] = 40
    max_dist['pedestrian.sitting_lying_down'] = 40
    max_dist['vehicle.moving'] = 50
    max_dist['vehicle.parked'] = 50
    max_dist['vehicle.stopped'] = 50
